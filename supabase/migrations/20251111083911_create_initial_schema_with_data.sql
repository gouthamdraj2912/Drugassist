...
INSERT INTO programs (name, sponsor, monetary_cap, description, enrollment_link) VALUES 
  ('Cancer Support Program', 'HealthCare Foundation', '$50,000 per year', 'Comprehensive support for cancer patients including treatment costs and medication assistance.', 'https://portal.copays.org/#/register'),
  ('Diabetes Care Program', 'MediCare Alliance', '$25,000 per year', 'Complete diabetes management program with medication coverage and regular monitoring.', 'https://portal.copays.org/#/register'),
  ('Heart Health Initiative', 'CardioWell Organization', '$40,000 per year', 'Cardiac care program covering medications, procedures, and preventive care.', 'https://portal.copays.org/#/register'),
  ('Arthritis Relief Program', 'Joint Health Foundation', '$30,000 per year', 'Support program for arthritis patients with medication assistance and therapy coverage.', 'https://portal.copays.org/#/register'),
  ('Respiratory Support Program', 'Breathe Easy Foundation', '$35,000 per year', 'Comprehensive respiratory care program including inhalers, treatments, and monitoring.', 'https://portal.copays.org/#/register')
ON CONFLICT DO NOTHING;